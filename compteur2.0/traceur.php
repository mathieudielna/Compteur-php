...
fwrite($traceur, "Dernier appareil connecte $appareil sous $os avec $browser le $date a $heure avec comme adresse IP: $ip ");
fseek($traceur, filesize('traceur.txt'));
